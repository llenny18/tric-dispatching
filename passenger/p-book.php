                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-heading left">
                                <h4>Select Your Bookimg Details</h4>
                            </div>
                                ...
                                <form id="contactForm" method="post" class="contact-form" action="sendemail.php">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label for="date">Rider</label>
                                            <select class="medium-textarea" rows="12" maxlength="1000" required="required" id="message" name="message">

                                                <option value="">Select Rider</option>
                                                <option value="Male">Name1</option>
                                                <option value="Female">Name2</option>
                                                <option value="Prefer Not Say">name3</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            ...
                                            <input type="date" class="medium-input" maxlength="70" placeholder="Username" required="required" id="date" name="date">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label for="time">Time of Booking</label>
                                            <input type="time" class="medium-input" maxlength="70" placeholder="Email" required="required" id="time" name="time">
                                        </div>
                                        
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label for="payment">Pickup Location</label>
                                            <input type="text" class="medium-input" maxlength="70" placeholder="Place Address" required="required" id="Pickup" name="Pickup">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <label for="payment">Destination Location</label>
                                            <input type="text" class="medium-input" maxlength="70" placeholder="Place address" required="required" id="Destination" name="Destination">
                                        </div>
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                        ...
                                        <div class="col-md-12 sm-margin-30px-bottom">
                                            <div class="top-contact wow fadeInRight text-left" style="visibility: visible; animation-name: fadeInRight;">
                                                <a type="submit" id="#services" href="#services" class="btn btn-primary wow fadeInUp  js-scroll-trigger" data-wow-delay="1s" style="visibility: visible; animation-delay: 1s; animation-name: fadeInUp;">Confirm Booking</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
