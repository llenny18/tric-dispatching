...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepare and bind
    $stmt = $conn->prepare("INSERT INTO passengers (name, home_address, work_address, pusername, ppassword, contact, email, gender) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssss", $name, $home_address, $work_address, $pusername, $ppassword, $contact, $email, $gender);

    // Execute the query
    if ($stmt->execute()) {
      echo '<script>alert("Register successful! Redirecting to login page."); window.location.href = "p-login.php";</script>';
                            ...
                            <form id="contactForm" method="post" class="contact-form" >
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        ...
                                        <input type="text" class="medium-input" placeholder="Username"  required id="uname" name="uname">
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <label for="pass">Password</label>
                                        <input type="text" class="medium-input" placeholder="Password"  required id="pass" name="pass">
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <label for="name">Name</label>
                                        <input type="text" class="medium-input" placeholder="Name" required id="name" name="name">
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <label for="home">Home Address</label>
                                        <input type="text" class="medium-input" placeholder="Home Address"  required id="home" name="home">
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <label for="work">Work Address</label>
                                        <input type="text" class="medium-input" placeholder="Work Address<"  required id="work" name="work">
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <label for="cnum">Contact Number</label>
                                        <input type="text" class="medium-input" placeholder="Contact" required id="cnum" name="cnum">
                                    </div>
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        <label for="email">Email</label>
                                        <input type="email" class="medium-input" placeholder="Email"  required id="email" name="email">
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-6">
                                        ...
                                        <select class="medium-textarea" rows="12" maxlength="1000" required id="gender" name="gender">
                                            ...
                                            <option value="etc" >Prefer Not Say</option>
                                        </select>
                                    </div>
                                    <div class="col-md-12">
